...
exports.buildOptionChainWithDeltas = void 0;
/**
 ...
 */
function buildOptionChainWithDeltas(currentRows, previousRows, symbol, expiry) {
    const filterRows = (rows) => rows.filter((r) => r.symbol.trim().toUpperCase() === symbol.trim().toUpperCase() &&
    ...
    for (const curr of currFiltered) {
        ...
        const deltaPremium = prevRow
            ...
            : undefined;
        const enhancedOption = Object.assign(Object.assign({}, curr), { deltaOI,
            deltaPremium });
        if (curr.optType === "CE") {
    ...
    return {
        ...
        symbol: symbol.trim(),
        expDate: expiry.trim(),
        strikes: Array.from(strikesMap.values()).sort((a, b) => a.strPrice - b.strPrice),
    };
}
exports.buildOptionChainWithDeltas = buildOptionChainWithDeltas;
